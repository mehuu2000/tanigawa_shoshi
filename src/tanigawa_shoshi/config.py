...
NEGATIVE_TITLE_REWRITE_REQUESTS_PATH = EVALUATION_DATA_DIR / "negative_title_rewrite_requests.json"
NEGATIVE_TITLE_REWRITE_RESULTS_PATH = EVALUATION_DATA_DIR / "negative_title_rewrite_results.json"
